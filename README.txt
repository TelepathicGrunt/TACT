...
- Tagged Quarry block as `minecraft:mineable/pickaxe` so it can be mined by pickaxes.
...
- Added Ancient Sapling to `minecraft:saplings` block tag.

- Added Pewen Sapling, Thornwood Sapling, and Ancient Sapling to `minecraft:saplings` item tag.
