...
public class Config {
    ...
    private static final ForgeConfigSpec.IntValue CLOAK_OF_DARKNESS_TICK_LENGTH;
    private static final ForgeConfigSpec.IntValue CLOAK_OF_DARKNESS_TICKS_TILL_RECHARGED;
    ...
    static {
        ...
        CLOAK_OF_DARKNESS_TICK_LENGTH = configBuilder
                .comment("""
                    ----------------------------------
                    
                     How long Cloak of Darkness can keep you in Darkness Incarnate mode.
                    """)
                .defineInRange("cloakOfDarknessTickLength", 200, 0, 1000000);

        CLOAK_OF_DARKNESS_TICKS_TILL_RECHARGED = configBuilder
                .comment("""
                    ----------------------------------
                    
                     How many ticks is required till Cloak of Darkness can use Darkness Incarnate mode again.
                    """)
                .defineInRange("cloakOfDarknessTicksTillRecharged", 1000, 0, 1000000);
    ...
    public static int cloakOfDarknessTickLength;
    public static int cloakOfDarknessTicksTillRecharged;
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        cloakOfDarknessTickLength = CLOAK_OF_DARKNESS_TICK_LENGTH.get();
        cloakOfDarknessTicksTillRecharged = CLOAK_OF_DARKNESS_TICKS_TILL_RECHARGED.get();
